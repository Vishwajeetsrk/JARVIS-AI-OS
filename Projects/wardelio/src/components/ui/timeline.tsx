...
export const Timeline = ({ data }: { data: { title: string; content: React.ReactNode }[] }) => {
  ...
  return (
    <div ref={containerRef} className="w-full bg-white font-sans dark:bg-neutral-950 md:px-10">
