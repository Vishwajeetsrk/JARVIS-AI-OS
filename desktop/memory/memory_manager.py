...
def extract_memory(user_text: str, JARVIS_text: str, api_key: str = "") -> dict:
    try:
        ...
        raw = client.chat(
            ...
            f"                  (e.g. mark_xxv: 'Building a JARVIS AI - Lite assistant')\n"
            ...
            f"- Extract from BOTH user and JARVIS AI turns.\n"
            ...
            f' "projects":{{"mark_xxv":{{"value":"JARVIS AI - Lite assistant"}}}},\n'
