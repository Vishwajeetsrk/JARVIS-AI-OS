...
title JARVIS AI - Lite - Premium Launcher
cd /d "%~dp0"
...
echo.
echo ==============================================
echo      JARVIS AI - Lite  ^| Premium Launcher
echo ==============================================
echo.
...
if exist "%PYW%" (
  start "JARVIS AI - Lite" /b "%PYW%" "%MAIN%" --startup
) else (
  start "JARVIS AI - Lite" /b "%PYCMD%" "%MAIN%" --startup
)
