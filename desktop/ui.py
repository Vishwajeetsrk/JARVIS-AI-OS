...
from smart_home_page_new import JARVISHomePage, _DeviceTile
...
LOGO_FILE  = BASE_DIR / "assets" / "JARVIS_Lite_Logo.png"
LOGO_ICO   = BASE_DIR / "assets" / "JARVIS_Lite_Logo.ico"
...
class RemoteKeyOverlay(QWidget):
    ...
    def mark_connected(self) -> None:
        ...
        self._timer_lbl.setText("Phone connected. JARVIS remote is ready.")
...
class TaskCard(QFrame):
    def __init__(self, parent=None):
        ...
        self._plan_lbl = QLabel("Plan: JARVIS will generate a task plan after you send a command.")
    ...
    def set_task(self, title: str, desc: str, percent: int):
        ...
        self._plan_lbl.setText("Plan: JARVIS will generate a task plan after you send a command.")
...
class ConversationFeed(QScrollArea):
    ...
    def _ensure_empty_widget(self):
        ...
        lay.setSpacing(10)
        title = QLabel("Try asking JARVIS")
...
class WorkspaceSidebar(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        header.addWidget(self._title)
        header.addStretch()
        self._close_btn = QPushButton("JARVIS")
    ...
    def append_log(self, text: str):
        ...
        if not raw:
            return
        low = raw.lower()
        if low.startswith(("you:", "JARVIS ai:")):
            return
    ...
    def record_chat_event(self, event: object):
        ...
        if role == "user":
            ...
            self._active_conversation_id = convo_id
            self._feed.add_message("assistant", "JARVIS", text, _fmt_time_stamp(stamp), attachments=attachments, animate=True)
            self._hide_memory_banner()
        elif role == "system":
...
class InlineChatWorkspace(QFrame):
    ...
    def record_chat_event(self, event: object):
        ...
        if role == "user":
            ...
            self._feed.add_message("assistant", "JARVIS", text, stamp, attachments=attachments)
            self._hide_memories()
        elif role == "system":
...
class LauncherControlPanel(QDialog):
    def __init__(self, *, startup_workspace: bool = False, on_open=None, on_close=None,
        ...
        self._restart_btn = mk_btn("Restart JARVIS")
        self._quit_btn = mk_btn("Quit JARVIS")
...
class LogWidget(QScrollArea):
    ...
    def _parse(self, text: str) -> tuple[str, str, str]:
        ...
        if tl.startswith("JARVIS ai:"):
            return "assistant", "JARVIS", raw[len("JARVIS AI:"):].strip()
        if tl.startswith("JARVIS:"):
            return "assistant", "JARVIS", raw[len("JARVIS:"):].strip()
...
class SetupOverlay(QWidget):
    ...
    def __init__(self, parent=None, defaults: dict | None = None):
        ...
        layout.addWidget(_lbl("Configure JARVIS before first boot.", 9, color=C.PRI_DIM))
        layout.addSpacing(6)
...
class CommandBar(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._input.setPlaceholderText("Tell JARVIS what to do...")
...
class DeveloperModeDialog(QDialog):
    def __init__(self, parent=None, settings: dict | None = None):
        ...
        desc = QLabel("Pick a workspace folder JARVIS should use when building websites or other workspace-based tasks.")
...
class ScanningOverlay(QWidget):
    def __init__(self, parent=None):
        ...
        self._splash_title = QLabel("JARVIS AI LITE")
...
class BootSequenceOverlay(QWidget):
    ...
    def _phase_initializing(self):
        if self._skip_requested:
            return
        self._set_phase(1, "JARVIS INITIALIZING...", "JARVIS Core waking up.")
    ...
    def _phase_greeting(self):
        ...
        if 5 <= hour < 12:
            ...
            greet = "Good Evening"
        self._set_phase(3, f"{greet}, {self._greeting_name}", "JARVIS Lite is ready.")
    ...
    def paintEvent(self, _):
        ...
        if self._phase == 0:
            ...
            p.drawText(QRectF(cx - 160 * scale, cy - 40 * scale, 320 * scale, 80 * scale), Qt.AlignmentFlag.AlignCenter, "JARVIS")
            ...
            if self._phase == 3:
                ...
                p.drawText(QRectF(0, cy + 203 * scale, rect.width(), 36), Qt.AlignmentFlag.AlignCenter, "JARVIS Lite is ready.")
...
class MeetingOverlay(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._answer = QLabel("JARVIS will show the live answer here.")
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, face_path: str):
        ...
        self.setWindowTitle("JARVIS AI - Lite")
    ...
    def _startup_enabled(self) -> bool:
        ...
        try:
            with winreg.OpenKey(
                ...
                try:
                    value, _ = winreg.QueryValueEx(key, "JARVIS AI - Lite")
                    run_value = _startup_run_value()
                    if value != run_value:
                        winreg.SetValueEx(key, "JARVIS AI - Lite", 0, winreg.REG_SZ, run_value)
                    return bool(value)
        ...
        try:
            with winreg.CreateKey(winreg.HKEY_CURRENT_USER, _startup_registry_key()) as key:
                if enabled:
                    ...
                    try:
                        winreg.DeleteValue(key, "JARVIS AI - Lite")
                    except FileNotFoundError:
                        pass
            return True
        except Exception as e:
    ...
    def _build_header(self) -> QWidget:
        ...
        lay.addWidget(_badge("JARVIS AI - LITE", C.PRI_DIM))
        lay.addStretch()
    ...
    def _tick_clock(self):
        ...
        if hasattr(self, "_core_status_lbl") and self._core_status_lbl is not None:
            self._core_status_lbl.setText("JARVIS is ready. Gemini 2.5 Flash · OpenRouter · Voice Connected · Memory Enabled")
    ...
    def _build_footer(self) -> QWidget:
        ...
        lay.addStretch()
        lay.addWidget(_fl("Suryaansh Tiwari  Â·  JARVIS AI - Lite  Â·  Open Source"))
        lay.addStretch()
    ...
    def _browse_attachment(self):
        path, _ = QFileDialog.getOpenFileName(
            self, "Attach a file to JARVIS", str(Path.home()),
            "All Files (*.*);;"
            "Images (*.jpg *.jpeg *.png *.gif *.webp *.bmp *.svg);;"
            "Documents (*.pdf *.docx *.txt *.md *.pptx);;"
            "Data (*.csv *.xlsx *.json *.xml);;"
        ...
        if hasattr(self, "_result_card") and low.startswith("you:"):
            ...
            if self.on_chat_event and user_msg:
                try:
                    ...
                    pass
        if hasattr(self, "_result_card") and low.startswith("JARVIS ai:"):
    ...
    def notify_phone_connected(self):
        ...
        self._log_sig.emit("SYS: Phone connected to JARVIS remote.")
    ...
    def _apply_state(self, state: str):
        ...
        if hasattr(self, "_task_card"):
            if state == "THINKING":
                self._task_card.set_task("Working on it...", "JARVIS is processing your request.", 72)
            elif state == "SPEAKING":
                self._task_card.set_task("Responding...", "JARVIS is speaking now.", 100)
            elif state == "MUTED":
                self._task_card.set_task("Microphone muted", "Voice input is paused.", 0)
            else:
                self._task_card.set_task("Ready", "JARVIS is idle and ready.", 0)
        if hasattr(self, "_result_card"):
            if state == "THINKING":
    ...
    def _build_left_panel_modern(self) -> QWidget:
        ...
        title = QLabel("<span style='color:#ff4545;'>JARVIS</span><br><span style='color:#ffffff;'>LITE</span>")
        ...
        self._nav_items["home"] = NavItem("JARVIS Home", active=False, letter="H")
    ...
    def _build_center_panel_modern(self, face_path: str) -> QWidget:
        ...
        self._core_status_lbl = QLabel("JARVIS is ready. Gemini 2.5 Flash · OpenRouter · Voice Connected · Memory Enabled")
        ...
        self._home_page = JARVISHomePage()
...
class SystemConnectivitySidebar(QFrame):
    def __init__(self, controller=None, parent=None):
        ...
        self._mk_quick_action("↻ Restart JARVIS AI", QStyle.StandardPixmap.SP_BrowserReload, self._restart)
...
class SystemConnectivityPage(QWidget):
    ...
    def _build_left_column(self):
        ...
        # Mobile connect
        mobile = self._card("Mobile Connect", "Connect your phone and control JARVIS remotely.")
        ml = mobile.layout()
        ...
        # Startup
        startup = self._card("Startup", "Use JARVIS with Windows startup preferences.")
        sl = startup.layout()
        ...
        # Shortcuts & Pinning
        shortcuts = self._card("Shortcuts & Pinning", "Create shortcuts and pin JARVIS to your Windows system.")
        ...
        # Discord bot
        discord = self._card("Discord Bot", "Mirror JARVIS between the app and your server.")
        dl = discord.layout()
        ...
        about = self._card("About JARVIS", "JARVIS AI Lite information only.")
        ab = about.layout()
    ...
    def _test_discord_from_page(self):
        ...
        if self._ctrl() and hasattr(self._ctrl(), "_win"):
            ...
            self._discord_msg.setText("Connected as JARVIS#9649" if self._discord_token.text().strip() else "Bot Offline")
    ...
    def refresh(self):
        ...
        if enabled and token:
            ...
            self._discord_msg.setText("Connected as JARVIS#9649")
        elif token:
    ...
    def _create_desktop_shortcut_logic(self):
        try:
            ...
            icon_path = base_dir / "assets" / "JARVIS_Lite_Logo.ico"
...
class SmartDevicesSection(QFrame):
    def __init__(self, controller=None, parent=None):
        ...
        """)
        self._open_home_btn.clicked.connect(self._open_JARVIS_home)
        ...
        empty_btn = QPushButton("Open JARVIS Home")
        ...
        """)
        empty_btn.clicked.connect(self._open_JARVIS_home)
...
class JARVISUI:
    def __init__(self, face_path: str, size=None, *, show_immediately: bool = True):
        ...
        self._app.setApplicationDisplayName("JARVIS AI - Lite")
        ...
        self._tray.setToolTip("JARVIS AI - Lite")
