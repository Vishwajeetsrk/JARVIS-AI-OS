...
class JARVISHomePage(QWidget):
    def __init__(self, parent=None):
        ...
        self.setObjectName("JARVISHomePageModern")
        self.setStyleSheet(f"QWidget#JARVISHomePageModern {{ background: {BG}; }} QScrollArea {{ background: transparent; border: none; }}")
    ...
    def _build_header(self, lay: QVBoxLayout):
        ...
        subtitle = QLabel("Control your smart home with JARVIS AI.")
    ...
    def _animate_voice(self):
        ...
        if hasattr(self, "_voice_cmd_lbl") and self._voice_cmd_lbl:
            self._voice_cmd_lbl.setText({"Idle": '"JARVIS"', "Listening": '"Turn bedroom fan to speed 4"', "Thinking": '"Understanding..."', "Executing": '"Applying command..."', "Completed": '"Done"'}.get(self._voice_state, '"JARVIS"'))
