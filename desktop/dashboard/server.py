...
<p>Press <strong style="color:#dde3ed">Mobile Connect</strong> in JARVIS to get a new QR code.</p>
</div></body></html>""")
...
<p>Connecting to JARVIS…</p>
    ...
    async def serve(self) -> None:
        ...
        print("[Dashboard] Press 'Mobile Connect' in JARVIS UI to get the QR code.")
        await uvicorn.Server(cfg).serve()
