...
const QUICK_ACTIONS = [
  {
    ...
    seed: "Run my morning briefing ΓÇö summarize active projects, list today's priorities, and flag any blockers.",
    accent: "#E69D45",
  },
  {
    icon: Rocket,
    label: "Golden Flow",
    description: "CEO ΓåÆ Build ΓåÆ Test ΓåÆ Deploy pipeline",
    seed: "Start the CEO golden flow for the current top project: plan ΓåÆ build ΓåÆ test ΓåÆ deploy.",
    accent: "#D97757",
  },
  {
    icon: TestTube,
...
// Jarvis engine status ΓÇö live from the server (DB probe + provider envs)
const ENGINE_STATUS = [
  ...
  return (
    <div className="flex h-full flex-col overflow-y-auto bg-noise">
      <div className="mx-auto w-full max-w-6xl flex-1 space-y-4 p-4 lg:p-6">
        ...
        {/* System Health Diagnostics, Auto-Start Status & 9 Autonomous Agents */}
        <SystemHealthMonitor />

        {/* Laptop Health, Storage Intelligence & Safe Cleanup Center */}
        <LaptopHealthCenter />
